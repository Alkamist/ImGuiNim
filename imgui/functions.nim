import
  std/macros,
  flags, enums, types, constructors
...
withNamespace("ImGui"):
  ...
  proc Begin*(name: cstring; p_open: ptr bool = nil; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc End*()
  proc BeginChild*(str_id: cstring; size: ImVec2 = constructImVec2(0, 0); border: bool = false; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc BeginChild*(id: ImGuiID; size: ImVec2 = constructImVec2(0, 0); border: bool = false; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc EndChild*()
  proc IsWindowAppearing*(): bool
  proc IsWindowCollapsed*(): bool
  proc IsWindowFocused*(flags: ImGuiFocusedFlags = 0.ImGuiFocusedFlags): bool
  proc IsWindowHovered*(flags: ImGuiHoveredFlags = 0.ImGuiHoveredFlags): bool
  ...
  proc SetNextWindowPos*(pos: ImVec2; cond: ImGuiCond = 0.ImGuiCond; pivot: ImVec2 = constructImVec2(0, 0))
  proc SetNextWindowSize*(size: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  ...
  proc SetNextWindowCollapsed*(collapsed: bool; cond: ImGuiCond = 0.ImGuiCond)
  proc SetNextWindowFocus*()
  proc SetNextWindowBgAlpha*(alpha: cfloat)
  proc SetWindowPos*(pos: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowSize*(size: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowCollapsed*(collapsed: bool; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowFocus*()
  proc SetWindowFontScale*(scale: cfloat)
  proc SetWindowPos*(name: cstring; pos: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowSize*(name: cstring; size: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowCollapsed*(name: cstring; collapsed: bool; cond: ImGuiCond = 0.ImGuiCond)
  ...
  proc InvisibleButton*(str_id: cstring; size: ImVec2; flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool
  ...
  proc Bullet*()
  proc BeginCombo*(label: cstring; preview_value: cstring; flags: ImGuiComboFlags = 0.ImGuiComboFlags): bool
  proc EndCombo*()
  ...
  proc DragFloat*(label: cstring; v: ptr cfloat; v_speed: cfloat = 1.0f; v_min: cfloat = 0.0f; v_max: cfloat = 0.0f; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragFloat2*(label: cstring; v: array[2, cfloat]; v_speed: cfloat = 1.0f; v_min: cfloat = 0.0f; v_max: cfloat = 0.0f; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragFloat3*(label: cstring; v: array[3, cfloat]; v_speed: cfloat = 1.0f; v_min: cfloat = 0.0f; v_max: cfloat = 0.0f; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragFloat4*(label: cstring; v: array[4, cfloat]; v_speed: cfloat = 1.0f; v_min: cfloat = 0.0f; v_max: cfloat = 0.0f; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragFloatRange2*(label: cstring; v_current_min: ptr cfloat; v_current_max: ptr cfloat; v_speed: cfloat = 1.0f; v_min: cfloat = 0.0f; v_max: cfloat = 0.0f; format: cstring = "%.3f"; format_max: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragInt*(label: cstring; v: ptr cint; v_speed: cfloat = 1.0f; v_min: cint = 0; v_max: cint = 0; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragInt2*(label: cstring; v: array[2, cint]; v_speed: cfloat = 1.0f; v_min: cint = 0; v_max: cint = 0; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragInt3*(label: cstring; v: array[3, cint]; v_speed: cfloat = 1.0f; v_min: cint = 0; v_max: cint = 0; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragInt4*(label: cstring; v: array[4, cint]; v_speed: cfloat = 1.0f; v_min: cint = 0; v_max: cint = 0; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragIntRange2*(label: cstring; v_current_min: ptr cint; v_current_max: ptr cint; v_speed: cfloat = 1.0f; v_min: cint = 0; v_max: cint = 0; format: cstring = "%d"; format_max: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragScalar*(label: cstring; data_type: ImGuiDataType; p_data: pointer; v_speed: cfloat = 1.0f; p_min: pointer = nil; p_max: pointer = nil; format: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc DragScalarN*(label: cstring; data_type: ImGuiDataType; p_data: pointer; components: cint; v_speed: cfloat = 1.0f; p_min: pointer = nil; p_max: pointer = nil; format: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderFloat*(label: cstring; v: ptr cfloat; v_min: cfloat; v_max: cfloat; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderFloat2*(label: cstring; v: array[2, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderFloat3*(label: cstring; v: array[3, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderFloat4*(label: cstring; v: array[4, cfloat]; v_min: cfloat; v_max: cfloat; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderAngle*(label: cstring; v_rad: ptr cfloat; v_degrees_min: cfloat = -360.0f; v_degrees_max: cfloat = +360.0f; format: cstring = "%.0f deg"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderInt*(label: cstring; v: ptr cint; v_min: cint; v_max: cint; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderInt2*(label: cstring; v: array[2, cint]; v_min: cint; v_max: cint; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderInt3*(label: cstring; v: array[3, cint]; v_min: cint; v_max: cint; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderInt4*(label: cstring; v: array[4, cint]; v_min: cint; v_max: cint; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderScalar*(label: cstring; data_type: ImGuiDataType; p_data: pointer; p_min: pointer; p_max: pointer; format: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc SliderScalarN*(label: cstring; data_type: ImGuiDataType; p_data: pointer; components: cint; p_min: pointer; p_max: pointer; format: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc VSliderFloat*(label: cstring; size: ImVec2; v: ptr cfloat; v_min: cfloat; v_max: cfloat; format: cstring = "%.3f"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc VSliderInt*(label: cstring; size: ImVec2; v: ptr cint; v_min: cint; v_max: cint; format: cstring = "%d"; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc VSliderScalar*(label: cstring; size: ImVec2; data_type: ImGuiDataType; p_data: pointer; p_min: pointer; p_max: pointer; format: cstring = nil; flags: ImGuiSliderFlags = 0.ImGuiSliderFlags): bool
  proc InputText*(label: cstring; buf: cstring; buf_size: csize_t; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags; callback: ImGuiInputTextCallback = nil; user_data: pointer = nil): bool
  proc InputTextMultiline*(label: cstring; buf: cstring; buf_size: csize_t; size: ImVec2 = constructImVec2(0, 0); flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags; callback: ImGuiInputTextCallback = nil; user_data: pointer = nil): bool
  proc InputTextWithHint*(label: cstring; hint: cstring; buf: cstring; buf_size: csize_t; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags; callback: ImGuiInputTextCallback = nil; user_data: pointer = nil): bool
  proc InputFloat*(label: cstring; v: ptr cfloat; step: cfloat = 0.0f; step_fast: cfloat = 0.0f; format: cstring = "%.3f"; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputFloat2*(label: cstring; v: array[2, cfloat]; format: cstring = "%.3f"; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputFloat3*(label: cstring; v: array[3, cfloat]; format: cstring = "%.3f"; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputFloat4*(label: cstring; v: array[4, cfloat]; format: cstring = "%.3f"; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputInt*(label: cstring; v: ptr cint; step: cint = 1; step_fast: cint = 100; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputInt2*(label: cstring; v: array[2, cint]; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputInt3*(label: cstring; v: array[3, cint]; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputInt4*(label: cstring; v: array[4, cint]; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputDouble*(label: cstring; v: ptr cdouble; step: cdouble = 0.0; step_fast: cdouble = 0.0; format: cstring = "%.6f"; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputScalar*(label: cstring; data_type: ImGuiDataType; p_data: pointer; p_step: pointer = nil; p_step_fast: pointer = nil; format: cstring = nil; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc InputScalarN*(label: cstring; data_type: ImGuiDataType; p_data: pointer; components: cint; p_step: pointer = nil; p_step_fast: pointer = nil; format: cstring = nil; flags: ImGuiInputTextFlags = 0.ImGuiInputTextFlags): bool
  proc ColorEdit3*(label: cstring; col: array[3, cfloat]; flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool
  proc ColorEdit4*(label: cstring; col: array[4, cfloat]; flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool
  proc ColorPicker3*(label: cstring; col: array[3, cfloat]; flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags): bool
  proc ColorPicker4*(label: cstring; col: array[4, cfloat]; flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags; ref_col: ptr cfloat = nil): bool
  proc ColorButton*(desc_id: cstring; col: ImVec4; flags: ImGuiColorEditFlags = 0.ImGuiColorEditFlags; size: ImVec2 = constructImVec2(0, 0)): bool
  ...
  proc TreeNodeEx*(label: cstring; flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool
  ...
  proc CollapsingHeader*(label: cstring; flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool
  proc CollapsingHeader*(label: cstring; p_visible: ptr bool; flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool
  proc SetNextItemOpen*(is_open: bool; cond: ImGuiCond = 0.ImGuiCond)
  proc Selectable*(label: cstring; selected: bool = false; flags: ImGuiSelectableFlags = 0.ImGuiSelectableFlags; size: ImVec2 = constructImVec2(0, 0)): bool
  proc Selectable*(label: cstring; p_selected: ptr bool; flags: ImGuiSelectableFlags = 0.ImGuiSelectableFlags; size: ImVec2 = constructImVec2(0, 0)): bool
  ...
  proc BeginPopup*(str_id: cstring; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc BeginPopupModal*(name: cstring; p_open: ptr bool = nil; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc EndPopup*()
  proc OpenPopup*(str_id: cstring; popup_flags: ImGuiPopupFlags = 0.ImGuiPopupFlags)
  proc OpenPopup*(id: ImGuiID; popup_flags: ImGuiPopupFlags = 0.ImGuiPopupFlags)
  proc OpenPopupOnItemClick*(str_id: cstring = nil; popup_flags: ImGuiPopupFlags = ImGuiPopupFlag.MouseButtonRight)
  proc CloseCurrentPopup*()
  proc BeginPopupContextItem*(str_id: cstring = nil; popup_flags: ImGuiPopupFlags = ImGuiPopupFlag.MouseButtonRight): bool
  proc BeginPopupContextWindow*(str_id: cstring = nil; popup_flags: ImGuiPopupFlags = ImGuiPopupFlag.MouseButtonRight): bool
  proc BeginPopupContextVoid*(str_id: cstring = nil; popup_flags: ImGuiPopupFlags = ImGuiPopupFlag.MouseButtonRight): bool
  proc IsPopupOpen*(str_id: cstring; flags: ImGuiPopupFlags = 0.ImGuiPopupFlags): bool
  proc BeginTable*(str_id: cstring; column: cint; flags: ImGuiTableFlags = 0.ImGuiTableFlags; outer_size: ImVec2 = constructImVec2(0.0f, 0.0f); inner_width: cfloat = 0.0f): bool
  proc EndTable*()
  proc TableNextRow*(row_flags: ImGuiTableRowFlags = 0.ImGuiTableRowFlags; min_row_height: cfloat = 0.0f)
  proc TableNextColumn*(): bool
  proc TableSetColumnIndex*(column_n: cint): bool
  proc TableSetupColumn*(label: cstring; flags: ImGuiTableColumnFlags = 0.ImGuiTableColumnFlags; init_width_or_weight: cfloat = 0.0f; user_id: ImGuiID = 0)
  ...
  proc BeginTabBar*(str_id: cstring; flags: ImGuiTabBarFlags = 0.ImGuiTabBarFlags): bool
  proc EndTabBar*()
  proc BeginTabItem*(label: cstring; p_open: ptr bool = nil; flags: ImGuiTabItemFlags = 0.ImGuiTabItemFlags): bool
  proc EndTabItem*()
  proc TabItemButton*(label: cstring; flags: ImGuiTabItemFlags = 0.ImGuiTabItemFlags): bool
  ...
  proc BeginDragDropSource*(flags: ImGuiDragDropFlags = 0.ImGuiDragDropFlags): bool
  proc SetDragDropPayload*(`type`: cstring; data: pointer; sz: csize_t; cond: ImGuiCond = 0.ImGuiCond): bool
  proc EndDragDropSource*()
  proc BeginDragDropTarget*(): bool
  proc AcceptDragDropPayload*(`type`: cstring; flags: ImGuiDragDropFlags = 0.ImGuiDragDropFlags): ptr ImGuiPayload
  ...
  proc IsItemHovered*(flags: ImGuiHoveredFlags = 0.ImGuiHoveredFlags): bool
  proc IsItemActive*(): bool
  proc IsItemFocused*(): bool
  proc IsItemClicked*(mouse_button: ImGuiMouseButton = 0.ImGuiMouseButton): bool
  ...
  proc BeginChildFrame*(id: ImGuiID; size: ImVec2; flags: ImGuiWindowFlags = 0.ImGuiWindowFlags): bool
  proc EndChildFrame*()
  ...
  proc GetMouseDragDelta*(button: ImGuiMouseButton = 0.ImGuiMouseButton; lock_threshold: cfloat = -1.0f): ImVec2
  proc ResetMouseDragDelta*(button: ImGuiMouseButton = 0.ImGuiMouseButton)
...
withNamespace("ImGui"):
  ...
  proc SetWindowPos*(window: ptr ImGuiWindow; pos: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowSize*(window: ptr ImGuiWindow; size: ImVec2; cond: ImGuiCond = 0.ImGuiCond)
  proc SetWindowCollapsed*(window: ptr ImGuiWindow; collapsed: bool; cond: ImGuiCond = 0.ImGuiCond)
  ...
  proc ItemAdd*(bb: ImRect; id: ImGuiID; nav_bb: ptr ImRect = nil; flags: ImGuiItemAddFlags = 0.ImGuiItemAddFlags): bool
  ...
  proc OpenPopupEx*(id: ImGuiID; popup_flags: ImGuiPopupFlags = 0.ImGuiPopupFlags)
  ...
  proc BeginColumns*(str_id: cstring; count: cint; flags: ImGuiOldColumnFlags = 0.ImGuiOldColumnFlags)
  proc EndColumns*()
  ...
  proc BeginTableEx*(name: cstring; id: ImGuiID; columns_count: cint; flags: ImGuiTableFlags = 0.ImGuiTableFlags; outer_size: ImVec2 = constructImVec2(0, 0); inner_width: cfloat = 0.0f): bool
  ...
  proc RenderColorRectWithAlphaCheckerboard*(draw_list: ptr ImDrawList; p_min: ImVec2; p_max: ImVec2; fill_col: ImU32; grid_step: cfloat; grid_off: ImVec2; rounding: cfloat = 0.0f; flags: ImDrawFlags = 0.ImDrawFlags)
  proc RenderNavHighlight*(bb: ImRect; id: ImGuiID; flags: ImGuiNavHighlightFlags = ImGuiNavHighlightFlag.TypeDefault)
  ...
  proc TextEx*(text: cstring; text_end: cstring = nil; flags: ImGuiTextFlags = 0.ImGuiTextFlags)
  proc ButtonEx*(label: cstring; size_arg: ImVec2 = constructImVec2(0, 0); flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool
  proc CloseButton*(id: ImGuiID; pos: ImVec2): bool
  proc CollapseButton*(id: ImGuiID; pos: ImVec2): bool
  proc ArrowButtonEx*(str_id: cstring; dir: ImGuiDir; size_arg: ImVec2; flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool
  ...
  proc ButtonBehavior*(bb: ImRect; id: ImGuiID; out_hovered: ptr bool; out_held: ptr bool; flags: ImGuiButtonFlags = 0.ImGuiButtonFlags): bool
  ...
  proc TreeNodeBehaviorIsOpen*(id: ImGuiID; flags: ImGuiTreeNodeFlags = 0.ImGuiTreeNodeFlags): bool
